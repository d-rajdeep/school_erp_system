...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold">Staff Attendance Report</h2>
        </div>

        {{-- Filter Form --}}
        <div class="card mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('school_admin.attendance.staff.report') }}">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-3 d-flex gap-2">
                            ...
                            <a href="{{ route('school_admin.attendance.staff.report') }}"
                        ...
                        <tbody>
                            @forelse ($attendances as $attendance)
                                <tr>
                                    ...
                                    <td>{{ $attendance->teacher->employee_register_id ?? 'N/A' }}</td>
                                    <td>{{ $attendance->teacher->fullname ?? 'N/A' }}</td>
                                    <td>
